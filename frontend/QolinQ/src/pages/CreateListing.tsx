              ...
              <div className="space-y-2">
                ...
                <Select value={formData.platform} onValueChange={v => setFormData({...formData, platform: v})}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="facebook_post">Facebook Post/Story</SelectItem>
                    <SelectItem value="tiktok_video">TikTok Video</SelectItem>
                    <SelectItem value="linkedin_post">LinkedIn Article/Post</SelectItem>
                    <SelectItem value="twitter_post">Twitter/X Post</SelectItem>
                    <SelectItem value="snapchat_spotlight">Snapchat Spotlight</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div className="space-y-2">
